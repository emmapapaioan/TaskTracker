...
https://user-images.githubusercontent.com/108992250/219679081-34ad6d8a-f656-43cf-9ad3-2683e5f8ae00.mp4

<hr>
This project is a basic implemantation of a task manager, where you can add your tasks by name, date and time. Also you can set a reminder for a specific task and moreover delete the task. The tasks are stored in json format in a local database.
